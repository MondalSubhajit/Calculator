...
class Two extends Component{
  render(){
    return(
    <View>
      {/* <Text onPress={()=>this.props.addDigit(this.props.calculate.expression + ""+ 2)}>{"Two"}</Text> */}
      <TouchableHighlight onPress={()=>this.props.addDigit(this.props.calculate.expression + ""+ 2)} underlayColor="white">
...
export default connect(mapStateToProps, matchDispatchToProps)(Two);