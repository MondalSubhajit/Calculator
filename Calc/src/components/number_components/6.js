...
class Six extends Component{
  render(){
    return(
    <View>
      {/* <Text onPress={()=>this.props.addDigit(this.props.calculate.expression + ""+ 6)}>{"Six"}</Text> */}
      <TouchableHighlight onPress={()=>this.props.addDigit(this.props.calculate.expression + ""+ 6)} underlayColor="white">
...
export default connect(mapStateToProps, matchDispatchToProps)(Six);