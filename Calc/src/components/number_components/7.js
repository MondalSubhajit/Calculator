...
class Seven extends Component{
  render(){
    return(
    <View>
      {/* <Text onPress={()=>this.props.addDigit(this.props.calculate.expression + ""+ 7)}>{"Seven"}</Text> */}
      <TouchableHighlight onPress={()=>this.props.addDigit(this.props.calculate.expression + ""+ 7)} underlayColor="white">
...
export default connect(mapStateToProps, matchDispatchToProps)(Seven);