...
class Three extends Component{
  render(){
    return(
    <View>
      {/* <Text onPress={()=>this.props.addDigit(this.props.calculate.expression + ""+ 3)}>{"Three"}</Text> */}
      <TouchableHighlight  onPress={()=>this.props.addDigit(this.props.calculate.expression + ""+ 3)} underlayColor="white">
...
export default connect(mapStateToProps, matchDispatchToProps)(Three);