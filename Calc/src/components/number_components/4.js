...
class Four extends Component{
  render(){
    return(
    <View>
      {/* <Text onPress={()=>this.props.addDigit(this.props.calculate.expression + ""+ 4)}>{"Four"}</Text> */}
      <TouchableHighlight  onPress={()=>this.props.addDigit(this.props.calculate.expression + ""+ 4)} underlayColor="white">
...
export default connect(mapStateToProps, matchDispatchToProps)(Four);