...
class Five extends Component{
  render(){
    return(
    <View>
      {/* <Text onPress={()=>this.props.addDigit(this.props.calculate.expression + ""+ 5)}>{"Five"}</Text> */}
      <TouchableHighlight onPress={()=>this.props.addDigit(this.props.calculate.expression + ""+ 5)} underlayColor="white">
...
export default connect(mapStateToProps, matchDispatchToProps)(Five);