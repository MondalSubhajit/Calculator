...
class One extends Component{
  render(){
    return(
    <View>
      {/* <Text onPress={()=>this.props.addDigit(this.props.calculate.expression + ""+ 1)}>{"One"}</Text> */}
      <TouchableHighlight onPress={()=>this.props.addDigit(this.props.calculate.expression + ""+ 1)} underlayColor="white">
...
export default connect(mapStateToProps, matchDispatchToProps)(One);