...
class Zero extends Component{
  render(){
    return(
    <View>
      {/* <Text onPress={()=>this.props.addDigit(this.props.calculate.expression + ""+ 0)}>{"Zero"}</Text> */}
      <TouchableHighlight onPress={()=>this.props.addDigit(this.props.calculate.expression + ""+ 0)} underlayColor="white">
...
export default connect(mapStateToProps, matchDispatchToProps)(Zero);