...
class Nine extends Component{
  render(){
    return(
    <View>
      {/* <Text onPress={()=>this.props.addDigit(this.props.calculate.expression + ""+ 9)}>{"Nine"}</Text> */}
      <TouchableHighlight  onPress={()=>this.props.addDigit(this.props.calculate.expression + ""+ 9)} underlayColor="white">
...
export default connect(mapStateToProps, matchDispatchToProps)(Nine);